...
describe('Test axiosCaseConverter', () => {
	...
	describe('AxiosStatic with exclude options(requestConvertExcludes and responseExcludeKeys)', () => {
		const data = { requestInterceptorId: 0, responseInterceptorId: 0 };

		beforeAll(() => {
			const options: Options = {
				requestExcludeKeys: ['snakeCaseExclude'],
				responseExcludeKeys: [/exclude$/]
			};
